...
if (pageURL.indexOf("?") > -1) {
    ...
    var isVueLoaded,isAxiosLoaded,isAirtableLoaded,isJqueryLoaded,isMapboxLoaded,isThereAEventContainer;
    const observer = new MutationObserver((mutations) => {
      if (mutations[0].attributeName === 'class') { 
        ...
        isThereAEventContainer = app.classList.contains('event-container-added');
