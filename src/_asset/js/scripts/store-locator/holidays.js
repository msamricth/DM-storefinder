...
let holidays = [],
    ...
    record_date,
    ending,
    currentDateFC = dt.toLocaleDateString('en-us', { weekday: "long", month: "short", day: "numeric" }),
    notHoliday = "true";
                   ...
                   // this.rTfields = response.data.records.fields;
                    ...
                    for (const day of dayIterations) {
                        ...
                        for (const holiday of holidays) {
                            ...
                            holidayDate = holidayDate.toLocaleDateString('en-us', { weekday: "long", month: "short", day: "numeric" }); //idk why it needs to be offseted by 1 day
                            if(day == 0){console.log(storeDateForComparison +' vs '+ holidayDate);}
